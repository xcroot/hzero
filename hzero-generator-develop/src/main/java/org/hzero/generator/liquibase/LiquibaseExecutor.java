...
import org.hzero.generator.liquibase.addition.ProfileMap;
import org.hzero.generator.liquibase.excel.ExcelDataLoader;
...
public class LiquibaseExecutor {
     ...
     * 用于获取jar中匹配参数设定的文件夹.
     */
    private String getDirInJar(List<File> fileList, String searchDir) throws LiquibaseException {
        if (searchDir == null) {
